...
Depending on how the `condidtion` variable is structured, you could have two different approaches to extracting the levels/values for each variable: manual-case-by-case assignment or automatic separation of a compound `condition`.
